...
public class Dense {
	protected static boolean dense_optimize(GRBEnv env, int rows, int cols, double[] c, // linear portion of objective
																						// function
	...
	public static void main(String[] args) {
		try {
			...
			success = dense_optimize(env, 2, 3, c, Q, A, sense, rhs, lb, null, null, sol);
			if (success) {
